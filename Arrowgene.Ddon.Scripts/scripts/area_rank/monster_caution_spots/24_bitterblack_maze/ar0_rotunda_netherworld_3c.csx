/**
 * @brief Enemy Spot in "Bitterblack Maze Rotunda" for "Netherworld 3" Variant C
 */
...
{
    public override StageLayoutId StageLayoutId => Stage.BitterblackMazeNetherworld3RoutundaCDeath.AsStageLayoutId(24);
    ...
    {
        return new byte[] { 0, 1, 2 }[Random.Shared.Next(0, 3)];
    }
