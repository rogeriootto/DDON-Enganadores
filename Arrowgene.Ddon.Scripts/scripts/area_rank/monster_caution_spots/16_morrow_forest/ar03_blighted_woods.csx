...
{
    public override StageLayoutId StageLayoutId => Stage.MorrowForest.AsStageLayoutId(9);
    ...
    public override void Initialize()
    {
        ...
        {
            LibDdon.Enemy.CreateAuto(EnemyId.SeverelyInfectedStymphalides, 70, 0)
            ...
            LibDdon.Enemy.CreateAuto(EnemyId.SeverelyInfectedStymphalides, 70, 4)
                .SetNamedEnemyParams(NamedParamId.Mutated),
            LibDdon.Enemy.CreateAuto(EnemyId.SeverelyInfectedStymphalides, 70, 5)
                .SetNamedEnemyParams(NamedParamId.Mutated),
        };

        var dropsTable = LibDdon.Enemy.GetDropsTable(enemies[0]).Clone()
        .AddDrop(ItemId.CrabBrittlegill, 1, 1, DropRate.UNCOMMON);
