...
{
    public override StageLayoutId StageLayoutId => Stage.KingalCanyon.AsStageLayoutId(37);
    ...
    public override void Initialize()
    {
        var enemies = new List<InstancedEnemy>()
        {
            ...
            .SetNamedEnemyParams(NamedParamId.Mutated),
            LibDdon.Enemy.CreateAuto(EnemyId.PhindymianSorcerer, 75, 2)
            .SetNamedEnemyParams(NamedParamId.Mutated),
            LibDdon.Enemy.CreateAuto(EnemyId.PhindymianSorcerer, 75, 3)
            .SetNamedEnemyParams(NamedParamId.Mutated),
            LibDdon.Enemy.CreateAuto(EnemyId.PhindymianElementArcher, 75, 4)
            .SetNamedEnemyParams(NamedParamId.Mutated)
        };

        var dropsTable = LibDdon.Enemy.GetDropsTable(enemies[0]).Clone()
        .AddDrop(ItemId.Kingalite, 1, 1, DropRate.VERY_COMMON);
