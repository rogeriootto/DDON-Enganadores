...
skillAugmentation.AddNode(1)
    ...
    .HasQuestDependency(QuestId.SkillAugmentationSorcererTrialI);
...
skillAugmentation.AddNode(5)
    .Location(4, 3)
    .BloodOrbCost(1200)
    .Unlocks(CustomSkillId.IciclePierce)
    .HasUnlockDependencies(2, 3);
...
skillAugmentation.AddNode(12)
    .Location(4, 5)
    .BloodOrbCost(1200)
    .Unlocks(AbilityId.MagickBoltSlayer)
...
skillAugmentation.AddNode(23)
    .Location(1, 8)
    .BloodOrbCost(1700)
    .Unlocks(AbilityId.MagickTrapCrush)
...
skillAugmentation.AddNode(26)
    .Location(7, 8)
    .BloodOrbCost(1700)
    .Unlocks(AbilityId.MagickCrackerSlayer)
...
skillAugmentation.AddNode(27)
    .Location(4, 9)
    .BloodOrbCost(1800)
    .Unlocks(AbilityId.EnduringLevitation)
...
skillAugmentation.AddNode(28)
    ...
    .HasQuestDependency(QuestId.SkillAugmentationSorcererTrialII);
...
skillAugmentation.AddNode(55)
    .Location(2, 18)
    .BloodOrbCost(1500)
    .Unlocks(AbilityId.MagickCrackerSmasher)
...
skillAugmentation.AddNode(57)
    .Location(6, 18)
    .BloodOrbCost(1500)
    .Unlocks(AbilityId.CollapsingStrength)
...
skillAugmentation.AddNode(58)
    ...
    .HasQuestDependency(QuestId.SkillAugmentationSorcererTrialIII);
...
skillAugmentation.AddNode(67)
    .Location(4, 22)
    .BloodOrbCost(2300)
    .Unlocks(CustomSkillId.LightningStake)
...
skillAugmentation.AddNode(74)
    .Location(2, 24)
    .BloodOrbCost(2600)
    .Unlocks(AbilityId.MagickBoltsCrusher)
    .HasUnlockDependencies(70, 71);

skillAugmentation.AddNode(75)
    .Location(6, 24)
    .BloodOrbCost(2600)
    .Unlocks(AbilityId.MagickTrapDuration)
...
skillAugmentation.AddNode(81)
    .Location(4, 26)
    .BloodOrbCost(2800)
    .Unlocks(AbilityId.MagickCrackerSinger)
...
skillAugmentation.AddNode(86)
    ...
    .HasQuestDependency(QuestId.SkillAugmentationSorcererTrialIV);
...
skillAugmentation.AddNode(107)
    .Location(3, 35)
    .BloodOrbCost(2800)
    .Unlocks(AbilityId.MagickTrapSinger)
    .HasUnlockDependencies(104);

skillAugmentation.AddNode(108)
    .Location(5, 35)
    .BloodOrbCost(2800)
    .Unlocks(AbilityId.PleasantDrift)
