...
{
    public override JobId JobId => JobId.ShieldSage;
...
skillAugmentation.AddNode(1)
    ...
    .HasQuestDependency(QuestId.SkillAugmentationShieldSageTrialI);
...
skillAugmentation.AddNode(10)
    .Location(3, 3)
    .BloodOrbCost(1800)
    .Unlocks(CustomSkillId.StoneLight)
...
skillAugmentation.AddNode(15)
    .Location(3, 4)
    .BloodOrbCost(1200)
    .Unlocks(AbilityId.ShieldbashSlayer)
...
skillAugmentation.AddNode(17)
    .Location(6, 4)
    .BloodOrbCost(1700)
    .Unlocks(AbilityId.WeaklightFury)
...
skillAugmentation.AddNode(23)
    .Location(1, 6)
    .BloodOrbCost(1600)
    .Unlocks(AbilityId.ForceBurstCrush)
...
skillAugmentation.AddNode(28)
    .Location(4, 8)
    .BloodOrbCost(1800)
    .Unlocks(AbilityId.ProtectedMend)
...
skillAugmentation.AddNode(29)
    ...
    .HasQuestDependency(QuestId.SkillAugmentationShieldSageTrialII);
...
skillAugmentation.AddNode(45)
    .Location(4, 12)
    .BloodOrbCost(1800)
    .Unlocks(AbilityId.ShieldCounterSavage)
...
skillAugmentation.AddNode(56)
    ...
    .HasQuestDependency(QuestId.SkillAugmentationShieldSageTrialIII);
...
skillAugmentation.AddNode(66)
    .Location(4, 19)
    .BloodOrbCost(2300)
    .Unlocks(CustomSkillId.ProtectionSwing)
...
skillAugmentation.AddNode(72)
    .Location(2, 21)
    .BloodOrbCost(2600)
    .Unlocks(AbilityId.ShieldBlowCrusher)
...
skillAugmentation.AddNode(74)
    .Location(6, 21)
    .BloodOrbCost(2600)
    .Unlocks(AbilityId.WeakLightCrusher)
...
skillAugmentation.AddNode(81)
    .Location(4, 23)
    .BloodOrbCost(3000)
    .Unlocks(AbilityId.ForceBurstSlayer)
...
skillAugmentation.AddNode(83)
    .Location(4, 24)
    .BloodOrbCost(3000)
    .Unlocks(AbilityId.ShieldCollapse)
...
skillAugmentation.AddNode(84)
    ...
    .HasQuestDependency(QuestId.SkillAugmentationShieldSageTrialIV);
...
skillAugmentation.AddNode(104)
    .Location(4, 31)
    .BloodOrbCost(2800)
    .Unlocks(AbilityId.ShieldSequenceCrusher)
...
skillAugmentation.AddNode(110)
    .Location(4, 33)
    .BloodOrbCost(3200)
    .Unlocks(AbilityId.PleasantSight)
