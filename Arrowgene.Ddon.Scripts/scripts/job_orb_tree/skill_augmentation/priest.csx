...
{
    public override JobId JobId => JobId.Priest;
...
skillAugmentation.AddNode(1)
    ...
    .HasQuestDependency(QuestId.SkillAugmentationPriestTrialI);
...
skillAugmentation.AddNode(7)
    .Location(4, 3)
    .BloodOrbCost(800)
    .Unlocks(CustomSkillId.SolaceRiser)
...
skillAugmentation.AddNode(17)
    .Location(2, 5)
    .BloodOrbCost(1600)
    .Unlocks(AbilityId.HealingChant)
...
skillAugmentation.AddNode(19)
    .Location(6, 5)
    .BloodOrbCost(1500)
    .Unlocks(AbilityId.BlastBitsSlayer)
...
skillAugmentation.AddNode(26)
    .Location(4, 7)
    .BloodOrbCost(1800)
    .Unlocks(AbilityId.SaintAuraSlayer)
...
skillAugmentation.AddNode(29)
    ...
    .HasQuestDependency(QuestId.SkillAugmentationPriestTrialII);
...
skillAugmentation.AddNode(47)
    .Location(3, 14)
    .BloodOrbCost(1800)
    .Unlocks(AbilityId.Stagnation)
    .HasUnlockDependencies(42);
skillAugmentation.AddNode(48)
    .Location(5, 14)
    .BloodOrbCost(1800)
    .Unlocks(AbilityId.ShockwaveSlayer)
...
skillAugmentation.AddNode(55)
    ...
    .HasQuestDependency(QuestId.SkillAugmentationPriestTrialIII);
...
skillAugmentation.AddNode(67)
    .Location(4, 21)
    .BloodOrbCost(2300)
    .Unlocks(CustomSkillId.BlastAddition)
...
skillAugmentation.AddNode(69)
    .Location(4, 22)
    .BloodOrbCost(2500)
    .Unlocks(AbilityId.HealAuraEndurer)
...
skillAugmentation.AddNode(79)
    .Location(3, 25)
    .BloodOrbCost(2600)
    .Unlocks(AbilityId.BlastBitsCrusher)
    .HasUnlockDependencies(74);
skillAugmentation.AddNode(80)
    .Location(5, 25)
    .BloodOrbCost(2600)
    .Unlocks(AbilityId.HolyAuraSavage)
...
skillAugmentation.AddNode(84)
    .Location(4, 27)
    .BloodOrbCost(3000)
    .Unlocks(AbilityId.MagickalRush)
...
skillAugmentation.AddNode(85)
    ...
    .HasQuestDependency(QuestId.SkillAugmentationPriestTrialIV);
...
skillAugmentation.AddNode(107)
    .Location(4, 34)
    .BloodOrbCost(2800)
    .Unlocks(AbilityId.ShockwaveCrusher)
