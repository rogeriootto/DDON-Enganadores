...
skillAugmentation.AddNode(17)
    .Location(1, 8)
    .BloodOrbCost(1200)
    .Unlocks(AbilityId.OnslaughtSlayer)
...
skillAugmentation.AddNode(22)
    .Location(7, 8)
    .BloodOrbCost(1200)
    .Unlocks(AbilityId.DemolishingStrikeSlayer)
    .HasUnlockDependency(16);

skillAugmentation.AddNode(23)
    .Location(2, 9)
    .BloodOrbCost(1700)
    .Unlocks(AbilityId.GougeEradicate)
...
skillAugmentation.AddNode(27)
    .Location(4, 10)
    .BloodOrbCost(1800)
    .Unlocks(AbilityId.CrushingBlow)
...
skillAugmentation.AddNode(47)
    .Location(2, 17)
    .BloodOrbCost(1700)
    .Unlocks(AbilityId.DireOnslaughtSlayer)
    .HasUnlockDependency(43);
skillAugmentation.AddNode(48)
    .Location(6, 17)
    .BloodOrbCost(1700)
    .Unlocks(AbilityId.FirmShield)
...
skillAugmentation.AddNode(64)
    .Location(4, 23)
    .BloodOrbCost(2300)
    .Unlocks(CustomSkillId.FlowingShieldSpiral)
...
skillAugmentation.AddNode(74)
    .Location(4, 26)
    .BloodOrbCost(2500)
    .Unlocks(AbilityId.OnslaughtCrusher)
    .HasUnlockDependency(68);
...
skillAugmentation.AddNode(78)
    .Location(1, 28)
    .BloodOrbCost(2800)
    .Unlocks(AbilityId.DemolishingStrikeExterminator)
...
skillAugmentation.AddNode(82)
    .Location(7, 28)
    .BloodOrbCost(2800)
    .Unlocks(AbilityId.GougeCrusher)
    .HasUnlockDependency(75);
...
skillAugmentation.AddNode(102)
    .Location(2, 36)
    .BloodOrbCost(2800)
    .Unlocks(AbilityId.DireOnslaughtCrusher)
...
skillAugmentation.AddNode(105)
    .Location(6, 36)
    .BloodOrbCost(2800)
    .Unlocks(AbilityId.PleasantThrust)
