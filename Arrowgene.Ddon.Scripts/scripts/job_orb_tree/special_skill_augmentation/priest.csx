...
skillAugmentation.AddNode(8)
    .Location(4, 3)
    .BloodOrbCost(4000)
    .Unlocks(CustomSkillId.SolaceRiserT)
...
skillAugmentation.AddNode(25)
    ...
    .Unlocks(CustomSkillId.SolaceRiserP);
#endregion
...
skillAugmentation.AddNode(34)
    ...
    .Unlocks(CustomSkillId.SeraphimFlapT);
...
skillAugmentation.AddNode(50)
    ...
    .Unlocks(CustomSkillId.SeraphimFlapP);
#endregion
...
skillAugmentation.AddNode(60)
    ...
    .Unlocks(CustomSkillId.CuringSpotT);
// Row 24
...
skillAugmentation.AddNode(75)
    ...
    .Unlocks(CustomSkillId.CuringSpotP);
#endregion
...
skillAugmentation.AddNode(92)
    ...
    .Unlocks(CustomSkillId.DefenseRiserT);
...
skillAugmentation.AddNode(100)
    ...
    .Unlocks(CustomSkillId.DefenseRiserP);
#endregion
