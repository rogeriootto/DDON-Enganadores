...
skillAugmentation.AddNode(8)
    .Location(4, 3)
    .BloodOrbCost(4000)
    .Unlocks(CustomSkillId.EarthShakeT)
...
skillAugmentation.AddNode(24)
    ...
    .Unlocks(OrbGainParamType.JobHpMax, 45);
// Row 9
skillAugmentation.AddNode(25)
    ...
    .Unlocks(CustomSkillId.EarthShakeP);
#endregion
...
skillAugmentation.AddNode(34)
    ...
    .Unlocks(CustomSkillId.ForceShieldT);
...
skillAugmentation.AddNode(50)
    ...
    .Unlocks(CustomSkillId.ForceShieldP);
#endregion
...
skillAugmentation.AddNode(53)
    ...
    .BloodOrbCost(3600)
    .HasUnlockDependencies(51)
    .Unlocks(OrbGainParamType.JobPhysicalAttack, 30);
// Row 21
...
skillAugmentation.AddNode(60)
    ...
    .Unlocks(CustomSkillId.RampartRaidT);
// Row 24
...
skillAugmentation.AddNode(68)
    ...
    .HighOrbCost(500)
    .HasUnlockDependencies(61, 65)
    .Unlocks(OrbGainParamType.JobMagicalDefence, 35);
...
skillAugmentation.AddNode(75)
    ...
    .Unlocks(CustomSkillId.RampartRaidP);
#endregion
...
skillAugmentation.AddNode(92)
    ...
    .Unlocks(CustomSkillId.HolyWallT);
...
skillAugmentation.AddNode(100)
    ...
    .Unlocks(CustomSkillId.HolyWallP);
#endregion
