...
skillAugmentation.AddNode(8)
    .Location(4, 3)
    .BloodOrbCost(4000)
    .Unlocks(CustomSkillId.FlamingBowT)
...
skillAugmentation.AddNode(25)
    ...
    .Unlocks(CustomSkillId.FlamingBowP);
#endregion
...
skillAugmentation.AddNode(34)
    ...
    .Unlocks(CustomSkillId.ExhaustingBowT);
...
skillAugmentation.AddNode(50)
    ...
    .Unlocks(CustomSkillId.ExhaustingBowP);
#endregion
...
skillAugmentation.AddNode(60)
    ...
    .Unlocks(CustomSkillId.HealingFlashT);
// Row 24
...
skillAugmentation.AddNode(75)
    ...
    .Unlocks(CustomSkillId.HealingFlashP);
#endregion
...
skillAugmentation.AddNode(92)
    ...
    .Unlocks(CustomSkillId.CripplingBowT);
...
skillAugmentation.AddNode(100)
    ...
    .Unlocks(CustomSkillId.CripplingBowP);
#endregion
