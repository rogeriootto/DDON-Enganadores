...
skillAugmentation.AddNode(8)
    .Location(4, 3)
    .BloodOrbCost(4000)
    .Unlocks(CustomSkillId.SavageLungeT)
...
skillAugmentation.AddNode(25)
    ...
    .Unlocks(CustomSkillId.SavageLungeP);
#endregion
...
skillAugmentation.AddNode(34)
    ...
    .Unlocks(CustomSkillId.PommelStrikeT);
...
skillAugmentation.AddNode(50)
    ...
    .Unlocks(CustomSkillId.PommelStrikeP);
#endregion
...
skillAugmentation.AddNode(60)
    ...
    .Unlocks(CustomSkillId.EscapeSlashT);
// Row 24
...
skillAugmentation.AddNode(75)
    ...
    .Unlocks(CustomSkillId.EscapeSlashP);
#endregion
...
skillAugmentation.AddNode(92)
    ...
    .Unlocks(CustomSkillId.SparkSlashT);
...
skillAugmentation.AddNode(100)
    ...
    .Unlocks(CustomSkillId.SparkSlashP);
#endregion
