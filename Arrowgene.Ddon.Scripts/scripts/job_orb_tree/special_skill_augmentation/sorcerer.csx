...
skillAugmentation.AddNode(8)
    .Location(4, 3)
    .BloodOrbCost(4000)
    .Unlocks(CustomSkillId.DarknessMistT)
...
skillAugmentation.AddNode(25)
    ...
    .Unlocks(CustomSkillId.DarknessMistP);
#endregion
...
skillAugmentation.AddNode(34)
    ...
    .Unlocks(CustomSkillId.FulminationT);
...
skillAugmentation.AddNode(50)
    ...
    .Unlocks(CustomSkillId.FulminationP);
#endregion
...
skillAugmentation.AddNode(60)
    ...
    .Unlocks(CustomSkillId.ComestionT);
// Row 24
...
skillAugmentation.AddNode(75)
    ...
    .Unlocks(CustomSkillId.ComestionP);
#endregion
