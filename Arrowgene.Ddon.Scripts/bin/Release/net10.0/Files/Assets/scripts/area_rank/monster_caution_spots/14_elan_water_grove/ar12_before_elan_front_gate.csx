...
{
    public override StageLayoutId StageLayoutId => Stage.ElanWaterGrove.AsStageLayoutId(40);
    ...
    public override void Initialize()
    {
        ...
        {
            LibDdon.Enemy.CreateAuto(EnemyId.GreenGuardian, 73, 0)
            ...
            .SetNamedEnemyParams(NamedParamId.Mutated),
            LibDdon.Enemy.CreateAuto(EnemyId.GreenGuardian, 73, 4)
            .SetNamedEnemyParams(NamedParamId.Mutated),
            LibDdon.Enemy.CreateAuto(EnemyId.GreenGuardian, 73, 5)
            .SetNamedEnemyParams(NamedParamId.Mutated),
            LibDdon.Enemy.CreateAuto(EnemyId.GreenGuardian, 73, 6)
            .SetNamedEnemyParams(NamedParamId.Mutated),
        };
