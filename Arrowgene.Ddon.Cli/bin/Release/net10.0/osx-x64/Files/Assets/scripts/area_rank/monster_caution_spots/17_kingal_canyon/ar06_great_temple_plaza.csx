...
{
    public override StageLayoutId StageLayoutId => Stage.KingalCanyon.AsStageLayoutId(18);
    ...
    public override void Initialize()
    {
        var enemies = new List<InstancedEnemy>()
        {
            ...
            .SetNamedEnemyParams(NamedParamId.Mutated),
            LibDdon.Enemy.CreateAuto(EnemyId.Grigori, 73, 2)
            .SetNamedEnemyParams(NamedParamId.Mutated),
            LibDdon.Enemy.CreateAuto(EnemyId.Grigori, 73, 3)
            .SetNamedEnemyParams(NamedParamId.Mutated),
        };

        var dropsTable = LibDdon.Enemy.GetDropsTable(enemies[0]).Clone()
        .AddDrop(ItemId.RingingOre, 1, 2, DropRate.UNCOMMON)
        .AddDrop(ItemId.AdamasOre, 1, 2, DropRate.UNCOMMON);
