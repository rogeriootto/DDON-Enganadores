...
skillAugmentation.AddNode(8)
    .Location(4, 3)
    .BloodOrbCost(4000)
    .Unlocks(CustomSkillId.PileBinderT)
...
skillAugmentation.AddNode(25)
    ...
    .Unlocks(CustomSkillId.PileBinderP);
#endregion
...
skillAugmentation.AddNode(34)
    ...
    .Unlocks(CustomSkillId.AlmaPillarT);
...
skillAugmentation.AddNode(50)
    ...
    .Unlocks(CustomSkillId.AlmaPillarP);
#endregion
...
skillAugmentation.AddNode(60)
    ...
    .Unlocks(CustomSkillId.AlmaWaveT);
// Row 24
...
skillAugmentation.AddNode(75)
    ...
    .Unlocks(CustomSkillId.AlmaWaveP);
#endregion
...
skillAugmentation.AddNode(92)
    ...
    .Unlocks(CustomSkillId.RexElementaT);
...
skillAugmentation.AddNode(100)
    ...
    .Unlocks(CustomSkillId.RexElementaP);
#endregion
