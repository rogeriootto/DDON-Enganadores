/**
 * @brief Enemy Spot in "Bitterblack Maze Abyss" for "Netherworld 4" Variant A
 */
...
{
    public override StageLayoutId StageLayoutId => Stage.BitterblackMazeNetherworld4AbyssADeath.AsStageLayoutId(5);
