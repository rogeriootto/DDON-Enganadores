/**
 * @brief Enemy Spot in "Bitterblack Maze Rotunda" for "Netherworld 3" Variant B
 */
...
{
    public override StageLayoutId StageLayoutId => Stage.BitterblackMazeNetherworld3RoutundaBDeath.AsStageLayoutId(8);
