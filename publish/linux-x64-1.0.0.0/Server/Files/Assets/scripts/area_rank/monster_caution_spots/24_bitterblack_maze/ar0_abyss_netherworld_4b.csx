/**
 * @brief Enemy Spot in "Bitterblack Maze Abyss" for "Netherworld 4" Variant B
 */
...
{
    public override StageLayoutId StageLayoutId => Stage.BitterblackMazeNetherworld4AbyssBDeath.AsStageLayoutId(6);
