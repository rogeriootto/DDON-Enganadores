...
/// </summary>
var InheritanceUnlockLevels = new List<(ushort UnlockLevel, byte BaseChance)>
{
    (0,  64),
    (6,  32),
    (11, 16),
...
/// </summary>
var StatUpgradeCost = new List<(byte Level, uint EPAmount)>
{
    (1, 1),
    (2, 3),
    (3, 4),
...
/// </summary>
var LevelingData = new List<(ushort Level, uint PPCost, byte EP)>()
{
    (  1,    0,   5), // 5
    (  2,  100,   5), // 10
    (  3,  300,   5), // 15
